...
T3CODE_PORT=13773 \
  "/Applications/T3 Code (JPA).app/Contents/MacOS/T3 Code (JPA)"
```
...
```sh
codesign --verify --deep --strict "/Applications/T3 Code (JPA).app"
codesign -d --entitlements :- "/Applications/T3 Code (JPA).app"
```
